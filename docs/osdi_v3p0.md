               ...
               5.1 OsdiDescriptor . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 20
                  ...
                  5.1.2 num_nodes . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 21
                                         ...
                                         2                                        
                                              ...
                                              Copyright©2022SemiModGmbH.Allrightsreserved.
            ...
            6  Constants                                            39            
               ...
               6.4 OsdiJacobianEntry flags . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 42
               ...
               6.8 OsdiInitError error-codes . . . . . . . . . . . . . . . . . . . . . . . . . . . 49
            ...
            All circuit simulators have their own unique interface for incorporating compact semicon-
            ductor device models. This slows down model integration, development, distribution and
            ...
            obtain Verilog-A language support quicker, at reduced implementation and time effort.
                                                                ...
                                                                Xyce              
                               OpenVAF                                            
              Verilog-A                       shared OSDI                         
                         Parsing, Code Optimization            Ngspice            
               Model                          library                             
            ...
            OSDI_DESCRIPTORSisalistofdevicedescriptorsoflengthOSDI_NUM_DESCRIPTORS.Adevicede-
                                                                                  
            scriptor is an instance of the OsdiDescriptor struct that contains all compiled information
            ...
            Forthemostpartthesetasksareperformedbytheevalfunction. Thisfunctioncalculates
            ...
            Thisformulationiswellsuitedforsimulatorsthatimplementharmonicbalancesimulations
            likeXyce. Thesesimulatorscansimplyusetheload_residual_resist,load_residual_react,
            load_jacobian_resistandload_jacobian_reactfunctionstocopytheresidualsandjacobian
            ...
            jacobianentriesintoasinglematrix. ForDCandACsimulationstheload_jacobian_resist
            ...
            in (2.2), instead of the usual formulation shown in (2.1). Therefore, the RHS of SPICE-
            like simulators contains further terms in addition to the residual. To support these
            ...
            calculate multiple results that can be accessed by the simulator with separate functions:
              ...
              • reactiveresidual-readwiththeload_residual_reactorload_spice_rhs_tranfunction
                or directly by using react_residual_off                           
              • resistivejacobianentries-readwiththeload_jacobian_resistorload_jacobian_tran
                function                                                          
            ...
            This function is intended for transient simulations in traditional simulators without sepa-
            rate resistive and reactive jacobian entries. Every reactive jacobian entry is multiplied
            ...
            The value returnedby thisfunction is used asthe result for$limit. init is trueif INIT_LIM
            ...
            Alistwithlengthnum_collapsiblethatcontainsOsdiNodePairthatarecollapsible,typically
            ...
            Afunctionpointertotheimplementationofthesetup_instancefunctionforthisdescriptor.
            ...
            networkshouldbeused. Therefore, everynoisesourcecanonlybeusedinsingleVerilog-A
            ...
            derivedfromtheVerilog-Adiscipline/naturesystemanddependonwhatkindofunknown
            ...
            InOSDInodesrefertoanysimulatorunknown. Usuallyequationsareformulatedinterms
            ...
            #define PARA_KIND_MODEL (0 << 30)                                     
            RepresentsanOsdiParamOpvarkind(seePARA_KIND_MASK).Thisbitpatternisusedformodel
            ...
            functionmustbecalledwiththisflagbeforetheload_jacobian_resist,load_spice_rhs_tran
            ...
            function mustbecalled with thisflag before theload_jacobian_react, load_spice_rhs_tran
            and load_spice_rhs_dc functions are called.                           
            ...
            Indicates logging with the $debug functions. These messages should be printed immedi-
            ately.                                                                
            ...
            Indicatesloggingwiththe$fatalfunction. Thesemessagesshouldbeprintedimmediately
            ...
            OSDIispredominantlyaimedatcompactmodelling. Inthecompactmodellingcommunity
            somepartsoftheVerilog-Alanguagearede-factonotused. Forallowingfastandconsistent
            ...
            residual Circuit simulators solve the equation F⃗ (⃗x) = ⃗0 with a newton iteration
                J(⃗x −⃗x ) = −F⃗ (⃗x ). The residual refers to the value F⃗ (⃗x ). For many
                   k+1  k       k                           k                     
            ...
            RHS Circuit simulators solve the equation F⃗ (⃗x) = ⃗0 with a newton iteration
                J(⃗x −⃗x ) = −F⃗ (⃗x ). To that end the equations A⃗y =⃗b is solved for ⃗y. A
                   k+1  k      k                                                  
                is the jacobian J and⃗b is the RHS. The exact definition of the RHS⃗b depends
                on the formulation of the newton algorithm used by the simulator. Usually
                the RHS is either equal to the residual⃗b = F⃗ (⃗x ) or also involves the jacobian
                                                 k                                
                ⃗b = J⃗x −F⃗ (⃗x ) . 10, 13, 14, 15, 79                           
                     k    k                                                       

...
This annex contains the standard definition packages (disciplines.vams, constants.vams and driv-
er_access.vams) for Verilog-AMS HDL. The copyright for these three files differs from the rest of the
Verilog-AMS HDL language reference manual to reflect that verbatim copies of these three standard defini-
tion files that make up this Annex may be used and distributed without restrictions.
